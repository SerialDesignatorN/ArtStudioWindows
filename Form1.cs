...
namespace Mainpaint
{
    public partial class Form1 : Form
    {
        ...
        #region discord_rich_presence
        public DiscordRpcClient client;

        void Initialize()
        {
            client = new DiscordRpcClient("844391160427839538");

            client.Logger = new ConsoleLogger() { Level = LogLevel.Warning };

            client.OnReady += (sender, e) =>
            {
                Console.WriteLine("Ready. Sent from user {0}", e.User.Username);
            };

            client.OnPresenceUpdate += (sender, e) =>
            {
                Console.WriteLine("Update received from {0}", e.Presence);
            };
            ...
            {
                Details = "For Windows",
                State = "Drawing an art",
                Assets = new Assets()
                {
                    LargeImageKey = "image_large",
                    LargeImageText = "Drawing",
        ...
        public void Message(string text, MessageType type, bool constant)
        {
            switch (type)
            {
                case MessageType.Warning:
                    toolStripStatusLabel2.Image = Mainpaint.Properties.Resources.warning;
                    break;
                case MessageType.Error:
                    toolStripStatusLabel2.Image = Mainpaint.Properties.Resources.error;
                    break;
            }
            ...
            else
            {
                ...
                switch (currentTool)
                {
                    ...
                    case DrawingSpace.Tool.Rotate:
                        ...
                        g.DrawString(anglex.ToString(), new Font("Calibri", 12.0f, FontStyle.Regular), new SolidBrush(Color.Black), new PointF(10, 10));
        ...
        private void OpenButton_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                using (Graphics gp = Graphics.FromImage(Space.SelectedLayerW.LayerImage))
                {
                    gp.DrawImage(new Bitmap(ofd.FileName), new Point(0, 0));
                    client.SetPresence(new RichPresence()
                    {
                        Details = "For Windows",
                        State = "Editing a photo",
                        Assets = new Assets()
                        {
                            LargeImageKey = "image_large",
                            LargeImageText = "Editing a photo",
                            SmallImageKey = "opened_image"
                        }
                    });
                }
                DrawUpdater(true);
        ...
        private void ToolDrawMode_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            grp.CopyFromScreen(rectangle.Location, Point.Empty, pictureBox1.Size);
            grp.Dispose();
            saveFileDialog1.Filter = "Image Files|*.jpg;*.png;*.tiff;*.bmp";
            if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                else if (saveFileDialog1.FileName.Contains(".tiff"))
                {
                    bitmap.Save(saveFileDialog1.FileName, ImageFormat.Tiff);
                    Console.WriteLine("Saved as TIFF");
                }
        ...
        private void connectToYourPhoneToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Are you sure you want to save your work?", "Alert", MessageBoxButtons.YesNo);
        ...
        private void NewButton_Click(object sender, EventArgs e)
        {
            ...
            {
                this.Text = "Art Studio Pro Suite | " + nw.ImageName;
                ImageSize = nw.ImageSize;
                client.SetPresence(new RichPresence()
                {
                    Details = "Current Art: " + nw.ImageName,
                    State = "Drawing an art",
                    Assets = new Assets()
                    {
                        LargeImageKey = "image_large",
                        LargeImageText = "Current Art: " + nw.ImageName,
                        SmallImageKey = "image_small"
                    }
                });
